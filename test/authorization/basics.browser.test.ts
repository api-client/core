...
import { 
  ...
  processPopupRawData,
  codeVerifierValue,
} from '../../src/authorization/OAuth2Authorization.js';
...
describe('OAuth2', () => {
  describe('Basic tests', () => {
    ...
    describe('[createErrorParams]()', () => {
      ...
      let client: OAuth2Authorization
      beforeEach(() => {
    ...
    describe('processCodeResponse()', () => {
      describe('JSON response', () => {
        ...
        let instance: OAuth2Authorization;
        beforeEach(() => {
