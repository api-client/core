...
import { handleTokenInfo, rejectFunction, resolveFunction, settingsValue, stateValue } from '../../src/authorization/OAuth2Authorization.js';
// export { IOidcTokenInfo } from '../../src/models/Authorization.js';
import { OidcAuthorization } from '../../src/authorization/OidcAuthorization.js';
import { IOpenIdProviderMetadata } from '../../src/authorization/types.js';
...
describe('OidcAuthorization', () => {
  ...
  describe('Unit tests', () => {
    ...
    describe('prepareTokens()', () => {
      let instance: OidcAuthorization;
    ...
    async function discovery(): Promise<IOpenIdProviderMetadata> {
      const response = await fetch(fullDiscoveryUrl);
      return response.json();
    }

    describe('authorization', () => {
      let info: IOpenIdProviderMetadata;
